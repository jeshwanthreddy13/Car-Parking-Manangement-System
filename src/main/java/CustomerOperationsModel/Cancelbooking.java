...
/*
 *
 * 		 Customer must be registered and logged-in before cancelling a parking space  [[done in REQ 4.2 and 4.3]]
 * 		Customer must enter the booking ID which is associated with their name
 * 		 The cancellation can only go through if the time of cancellation is before the booking expiry time
 */
