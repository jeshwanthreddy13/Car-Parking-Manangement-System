...
public class HomePage extends JFrame {
	...
	public HomePage() {
		...
		// location options
		String[] locOptions = {"PES Ec campus", "PES RR campus", "BMS", "RV", "Manipal"};
...
//		lst.addActionListener(this);
		...
		lst.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selLoc.equals("PES Ec campus")) {
					locationCode.setText("Ec");
				} else if (selLoc.equals("PES RR campus")) {
					locationCode.setText("rr");
				} else if (selLoc.equals("BMS")) {
					locationCode.setText("bms");
				} else if (selLoc.equals("RV")) {
					locationCode.setText("rv");
				} else if (selLoc.equals("Manipal")) {
					locationCode.setText("man");
				} else {}
